...
def main( ):
    ...
    train_instance_pooling, rest_train, _ = DeepRR(fmap1, is_training=True)
    test_instance_pooling, rest_test, _ = DeepRR(fmap2, reuse=True, is_training=False)
